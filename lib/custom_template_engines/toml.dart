...
/// An advanced TOML templating engine that supports:
/// - Variable substitution: {{ key }}
/// - Conditional blocks: {{ if condition }}...{{ endif }}
/// - Loops: {{ for item in list }}...{{ endfor }}
/// - Filters: {{ key | filterName }}
/// - Dynamic expression evaluation: {{ if age < 18 }}...{{ endif }}
class TomlTemplateEngine implements CustomTemplateEngine {
  @override
  ContentType contentType() => ContentType("application", "toml");
