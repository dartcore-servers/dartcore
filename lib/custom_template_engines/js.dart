...
/// A JavaScript templating engine that supports:
/// - Variable substitution: {{ key }}
/// - Conditional blocks: {{ if condition }}...{{ endif }}
/// - Loops: {{ for item in list }}...{{ endfor }}
/// - Filters: {{ key | filterName }}
/// - Dynamic expression evaluation: {{ if width < 500 }}...{{ endif }}
class JavaScriptTemplateEngine implements CustomTemplateEngine {
  @override
  ContentType contentType() => ContentType("application", "javascript");
